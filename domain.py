...
this is ( r, theta, phi ). But for a particle on a CylindricalSurface, moving 
in 1 dimension, just ( z ) is sufficient.
...
'''
For example the ( r, theta ) domain used with PairGreensFunctions (3D as well 
as 2D).
'''
